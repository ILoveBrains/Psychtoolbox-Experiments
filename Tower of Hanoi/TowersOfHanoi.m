...
%--------------------------------------------------------------------------
    ...
    properties (GetAccess = private, Constant = true)
        % Constants
        tic;
        defaultNBlocks = 3;         % Default number of blocks
        minNBlocks = 3;             % Minimum number of blocks (>= 2)
        maxNBlocks = 5;            % Maximum number of blocks
    ...
    methods (Access = private)
        ...
        function HandleKeyPress(this)
            ...
            if (this.solving == false)
                ...
                toc
                if toc >= 300
                    %OUTPUT THE STOP MESSAGE TO EEG
                    %outp(hex2dec('D050'),12);
                    h = msgbox('You are done with this task, please wait for the experimenter to come back and instruct you further');
                end    
            end
        end
...
%         end
        ...
        function CreateGUI(this)
            ...
            nMoves=0;
            % Send Start Trigger
            %outp(hex2dec('D050'),11);

            %Send start event code
